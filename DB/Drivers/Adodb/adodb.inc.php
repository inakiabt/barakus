...
*/
   ...
   */
	...
	*/
	...
	function &GetActiveRecordsClass($class, $table,$whereOrderBy=false,$bindarr=false, $primkeyArr=false, $join = '')
	{
	global $_ADODB_ACTIVE_DBS;

		$save = $this->SetFetchMode(ADODB_FETCH_NUM);                                  
		if (empty($whereOrderBy)) $whereOrderBy = '1=1';
		$rows = $this->GetAll("select ".$table.".* from ".$table.' '.$join.' WHERE '.$whereOrderBy,$bindarr);
