...
Barakus::import('Barakus.Classes.View');
 ...
 */
 ...
 class InternationalView extends View {
	...
	{                        
        ...
        foreach( $this->a_languages as $lng) {

            if( $this->loadLanguageTable($lng)) {
				$this->cur_language = $lng;
                break;
            }
        }
        $this->assign('BarakusLang', $this->cur_language);
	}
